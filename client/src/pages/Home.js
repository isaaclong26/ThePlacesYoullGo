            ...
            <Container className="my-5">
                <Row>
                    <Col data-aos="fade-up" className="m-4 default">
                        ...
                        <hr />
                        <h6>If you are just visiting or new to the site, onClick “Register” at the top of this page. If you have visited before and having already started planning your next vaycay, just “Log In” to continuing planning your trip.</h6>
                    </Col >
                </Row>
            </Container>
